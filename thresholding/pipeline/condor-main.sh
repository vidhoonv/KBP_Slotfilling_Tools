...
do
	...
	./condorizer-16G.py ./generate_threshold.sh $relation  0 0.01 1 2013-lsv-with-ut-inference-setthresholds-updated.txt ../../../lsv/relationfactory-master/evaluation/queries/queries-2013.xml  key_file_2013 lsv_inference_thresholds.txt "condor-files/condor-run-$relation.out"
#	break
done
